...
/*
Agora declare outra variáveis chamadas `subtraction`, `subtraction`,
`division` e `mod`, e atribua à elas `calculator`, passando números
diferentes para cada chamada.
*/
  var subtraction    = calculator(20,10);
  var division       = calculator(30,10);
  var mod            = calculator(200,20);
  var multiplication = calculator(8,10);
...
// O resultado da multiplicação é: 80
