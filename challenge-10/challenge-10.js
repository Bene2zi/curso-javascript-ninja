...
*/
var operation = { '+' : function(x,y){ return x + y; }, 
...
*/
  //Converti para função para utilizar uma linha apenas posteriormente;
    function calc(oper,number1,number2,operador){
     if(oper){
        console.log(showOperationMessage(operador,number1,number2), oper(number1,number2));
     }else{ 
  ...
  number1 = 10;
  number2 = 20;
  calc(sum,number1,number2,operationSignal);
...
*/
  ...
  number1 = 40;
  number2 = 20;
  calc(subtraction,number1,number2,operationSignal);  
  
  operationSignal = '*';
  var multiplication = calculator(operationSignal); 
  number1 = 100;
  number2 = 20;
  calc(multiplication,number1,number2,operationSignal);    

  operationSignal = '/';
  var division = calculator(operationSignal); 
  number1 = 100;
  number2 = 20;
  calc(division,number1,number2,operationSignal); 
  
  operationSignal = '%';
  var mod = calculator(operationSignal);   
  number1 = 100;
  number2 = 20;
  calc(mod,number1,number2,operationSignal);   
...
*/
  ...
  number1 = 100;
  number2 = 20;
  calc(invalid,number1,number2,operationSignal); 
