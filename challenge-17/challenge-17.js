...
console.log( text.replace(/Manuel Marques de Sousa/,'Fabricio Beneduzi'));
...
console.log(text.replace(/brasileiro/g,'barbosense'));
...
var regexD = /\d/g;
console.log( text.replace(regexD,'-'));
...
var regexDh = /\w[D-Hd-h]/g;
console.log(text.replace(regexDh,'0'));
