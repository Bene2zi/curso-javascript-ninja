...
*/
  ...
  */
  ...
  var Joao     = new Person('Joao','Casagrande',27);
  var Douglas  = new Person('Douglas','Ribeiro', 29);
  var Anderson = new Person('Anderson','Kowalkzuk', 21);
  ...
  */
  ...
  console.log(Anderson.getFullName(), 'agora tem', Anderson.getAge(), 'anos');
